 ...
 */
package com.xbing.app.net.okhttp3;
 ...
 *
 * 度量事件的侦听器。扩展此类以监视应用程序的HTTP调用的数量、大小和持续时间。
 *
...
public abstract class EventListener {
  ...
  public void callStart(Call call) {
    Log.e("OKHTTP_ZB","callStart:" + new Date().toLocaleString() + ":" + System.currentTimeMillis()%1000);
  }
  ...
  public void dnsStart(Call call, String domainName) {
    Log.e("OKHTTP_ZB","dnsStart:" + new Date().toLocaleString() + ":" + System.currentTimeMillis()%1000);
  }
  ...
  public void dnsEnd(Call call, String domainName, List<InetAddress> inetAddressList) {
    Log.e("OKHTTP_ZB","dnsEnd:" + new Date().toLocaleString() + ":" + System.currentTimeMillis()%1000);
  }
  ...
  public void connectStart(Call call, InetSocketAddress inetSocketAddress, Proxy proxy) {
    Log.e("OKHTTP_ZB","connectStart:" + new Date().toLocaleString() + ":" + System.currentTimeMillis()%1000);
  }
  ...
  public void secureConnectStart(Call call) {
    Log.e("OKHTTP_ZB","secureConnectStart:" + new Date().toLocaleString() + ":" + System.currentTimeMillis()%1000);
  }
  ...
  public void secureConnectEnd(Call call, @Nullable Handshake handshake) {
    Log.e("OKHTTP_ZB","secureConnectEnd:" + new Date().toLocaleString() + ":" + System.currentTimeMillis()%1000);
  }
  ...
  public void connectEnd(Call call, InetSocketAddress inetSocketAddress, Proxy proxy,
    ...
    Log.e("OKHTTP_ZB","connectEnd:" + new Date().toLocaleString() + ":" + System.currentTimeMillis()%1000);
  }
  ...
  public void connectFailed(Call call, InetSocketAddress inetSocketAddress, Proxy proxy,
    ...
    Log.e("OKHTTP_ZB","connectFailed:" + new Date().toLocaleString() + ":" + System.currentTimeMillis()%1000);
  }
  ...
  public void connectionAcquired(Call call, Connection connection) {
    Log.e("OKHTTP_ZB","connectionAcquired:" + new Date().toLocaleString() + ":" + System.currentTimeMillis()%1000);
  }
  ...
  public void connectionReleased(Call call, Connection connection) {
    Log.e("OKHTTP_ZB","connectionReleased:" + new Date().toLocaleString() + ":" + System.currentTimeMillis()%1000);
  }
  ...
  public void requestHeadersStart(Call call) {
    Log.e("OKHTTP_ZB","requestHeadersStart:" + new Date().toLocaleString() + ":" + System.currentTimeMillis()%1000);
  }
  ...
  public void requestHeadersEnd(Call call, Request request) {
    Log.e("OKHTTP_ZB","requestHeadersEnd:" + new Date().toLocaleString() + ":" + System.currentTimeMillis()%1000);
  }
  ...
  public void requestBodyStart(Call call) {
    Log.e("OKHTTP_ZB","requestBodyStart:" + new Date().toLocaleString() + ":" + System.currentTimeMillis()%1000);
  }
  ...
  public void requestBodyEnd(Call call, long byteCount) {
    Log.e("OKHTTP_ZB","requestBodyEnd:" + new Date().toLocaleString() + ":" + System.currentTimeMillis()%1000);
  }
  ...
  public void responseHeadersStart(Call call) {
    Log.e("OKHTTP_ZB","responseHeadersStart:" + new Date().toLocaleString() + ":" + System.currentTimeMillis()%1000);
  }
  ...
  public void responseHeadersEnd(Call call, Response response) {
    Log.e("OKHTTP_ZB","responseHeadersEnd:" + new Date().toLocaleString() + ":" + System.currentTimeMillis()%1000);
  }
  ...
  public void responseBodyStart(Call call) {
    Log.e("OKHTTP_ZB","responseBodyStart:" + new Date().toLocaleString() + ":" + System.currentTimeMillis()%1000);
  }
  ...
  public void responseBodyEnd(Call call, long byteCount) {
    Log.e("OKHTTP_ZB","responseBodyEnd:" + new Date().toLocaleString() + ":" + System.currentTimeMillis()%1000);
  }
  ...
  public void callEnd(Call call) {
    Log.e("OKHTTP_ZB","callEnd:" + new Date().toLocaleString() + ":" + System.currentTimeMillis()%1000);
  }
  ...
  public void callFailed(Call call, IOException ioe) {
    Log.e("OKHTTP_ZB","callFailed:" + new Date().toLocaleString() + ":" + System.currentTimeMillis()%1000);
  }
