...
public class Dump {
    ...
    public void doDump(Context c) {
        ...
        File gfxFile = new File("data/data/com.xbing.app.component/resource/gfx.txt");
        try {
            if (!gfxFile.exists()) {
            ...
            Method method = application.getDeclaredMethod("dumpGfxInfo", new Class[]{ParcelFileDescriptor.class, String[].class});
            method.setAccessible(true);
            method.invoke(currentActivityThread.getApplicationThread() , fd , new String[]{"com.xbing.app.component"});
